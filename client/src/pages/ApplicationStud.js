    ...
    <div className="bg-[#40189D] w-full min-h-screen h-full flex font-main">
        ...
        <div className="bg-[#F2F2F2] w-full px-10 pt-4 ml-10 rounded-l-3xl">
            ...
            <div className="flex justify-between mt-2">
                ...
                <button className="bg-[#40189D] w-20 h-6 mt-3 rounded-2xl  hover:bg-violet-600 active:bg-violet-700">
                <div className="text-white font-medium text-center">All</div>
                </button>
        
                <button className="bg-[#dfcef7] w-20 h-6 mt-3 rounded-2xl hover:bg-[#c69eff] ">
                <div className="text-[#808080] font-medium text-center">Pending</div>
                </button>
        
                <button className="bg-[#dfcef7] w-20 h-6 mt-3 rounded-2xl hover:bg-[#c69eff]">
                <div className="text-[#808080] font-medium text-center">On-Hold</div>
                </button>
        
                <button className="bg-[#dfcef7] w-20 h-6 mt-3 rounded-2xl hover:bg-[#c69eff]">
                <div className="text-[#808080] font-medium text-center">Candidate</div>
                </button>
            ...
            <div className="bg-white rounded-t-lg mt-3">
                <div className=" flex justify-around p-3">
                    ...
                    <div className="text-xl font-bold mt-4">ID</div>
                    <div className="text-xl font-bold mt-4">Date Applied</div>
                    <div className="text-xl font-bold mt-4">Logo</div>
            ...
            <div className="bg-white mt-1">
                <div className=" flex justify-around p-3">
                    <div className="border-solid border border-[#808080] rounded-md w-4 h-4 mt-5 bg-[#FFF9F9]"/>
                    <div className="text-sm font-semibold mt-4">#APL-0001</div>
                    <div className="text-sm font-semibold mt-4">June 1, 2020, 8:22 AM</div>
            ...
            <div className="bg-white mt-1">
                <div className=" flex justify-around p-3">
                    ...
                    <div className="bg-white text-[#FEB782] text-sm border border-[#FEB782] font-bold py-2 px-4 rounded-full">On-Hold</div>
                    {/* <div className="border-solid border border-[#808080] rounded-md w-4 h-4 mt-5 bg-[#FFF9F9]"/> */}
                </div>
            </div>
            ...
            <div className="bg-white mt-1">
                <div className=" flex justify-around p-3">
                    ...
                    <div className="bg-[#2AC154] text-[#FFFFFF] text-sm border border-[#FFFFFF] font-bold py-2 px-4 rounded-full">Candidate</div>
                    {/* <div className="border-solid border border-[#808080] rounded-md w-4 h-4 mt-5 bg-[#FFF9F9]"/> */}
                </div>
            </div>
