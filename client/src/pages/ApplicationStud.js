      ...
      <div className="bg-[#F2F2F2] w-full px-10 pt-4 ml-10 rounded-l-3xl">
        ...
        <div className="flex justify-between mt-2">
          ...
          <button className="bg-[#dfcef7] w-20 h-6 mt-3 rounded-2xl hover:bg-[#c69eff] ">
            <div className="text-[#808080] font-medium text-center">
              Pending
            </div>
          </button>
        ...
        <div className="bg-white mt-1">
          <div className=" flex justify-around p-3">
            ...
            <div className="bg-white text-[#808080] text-sm border border-[#808080] font-bold py-2 px-4 rounded-full">
              Pending
            </div>
            {/* <div className="border-solid border border-[#808080] rounded-md w-4 h-4 mt-5 bg-[#FFF9F9]"/> */}
          </div>
        ...
        <div className="bg-white mt-1">
          <div className=" flex justify-around p-3">
            ...
            <div className="bg-white text-[#FEB782] text-sm border border-[#FEB782] font-bold py-2 px-4 rounded-full">
              On-Hold
            </div>
            {/* <div className="border-solid border border-[#808080] rounded-md w-4 h-4 mt-5 bg-[#FFF9F9]"/> */}
          </div>
        ...
        <div className="bg-white mt-1">
          <div className=" flex justify-around p-3">
            ...
            <div className="bg-[#2AC154] text-[#FFFFFF] text-sm border border-[#FFFFFF] font-bold py-2 px-4 rounded-full">
              Candidate
            </div>
            {/* <div className="border-solid border border-[#808080] rounded-md w-4 h-4 mt-5 bg-[#FFF9F9]"/> */}
          </div>
        ...
        <div className="flex justify-end">
          ...
          <div className="bg-[#dfcef7] w-44 h-10  rounded-2xl flex justify-evenly">
            <div className="text-purple font-sm font-semibold align-middle">
              Pages
            </div>
          </div>
