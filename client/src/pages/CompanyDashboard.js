                    ...
                    <div className="max-w-7xl mx-auto py-6 px-6">
                        ...
                        <div className="flex mt-[2%] relative">
                            ...
                            <div className="bg-white rounded-[34px] p-8 w-full">
                                <h1 className="flex font-[Raleway] text-[20px] ">Company Information</h1>
                                <div>
                                    <div className="flex mt-[5%] whitespace-nowrap ">
                                        <div className='justify-items-start mr-60'>
                                            <h1 className=' font-[Raleway] text-[15px]'>Phone Number</h1>
                                            <p>7646553256</p>
                                        </div>
                                    ...
                                    <div className="flex mt-[5%] whitespace-nowrap ">
                                        ...
                                        <div className='justify-items-start'>
                                            ...
                                            <a href="www.abc.com" target={'_blank'}>www.abc.com</a>
                                        </div>
                                    </div>
                                    <div className="flex justify-between mt-[5%]">
                                        <div>
                                            <h1 className=' font-[Raleway] text-[15px]'>Description</h1>
                                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus commodi, nemo animi corporis ab recusandae corrupti optio dolorum quod, aliquid fugit vel, culpa velit? Necessitatibus?</p>
                                        </div>
                                    </div>
