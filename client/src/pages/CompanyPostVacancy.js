...
const CompanyPostVacancy = () => {
  return (
    <div className='bg-purple w-full h-screen flex font-main'>
        ...
        <div className="bg-[#F2F2F2] w-full px-10 pt-4 ml-10 rounded-l-3xl flex flex-wrap justify-center items-center">
            <div className="flex flex-col w-1/2 h1/2">
                <div className="flex flex-row items-baseline content-center justify-center">
                    ...
                    <select name="type" className="rounded-sm border border-purple w-48 focus:outline-none pl-2 py-1">
                ...
                <div className="container rounded-2xl bg-lightPurple min-w-full min-h-full p-10">
                    <form>
                        ...
                        <div className="flex flex-row flex-wrap justify-between">
                            ...
                            <div className="flex flex-col min-w-[40%] min-h-full mb-4">
                                <label className="mb-4 font-bold">Duration:</label>
                                <input type='text' name='positionCount' className="rounded-xl border border-purple w-48 focus:outline-none pl-4 py-1" />
                            </div>
                        </div>
                        <div className="flex flex-row flex-wrap justify-between">
