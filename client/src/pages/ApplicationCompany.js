        ...
        <div className="bg-[#F2F2F2] w-full px-10 pt-4 ml-10 rounded-l-3xl">
            ...
            <div className="bg-white mt-1">
                <div className=" flex justify-around p-3">
                    ...
                    <button className="text-sm font-semibold text-[#40189D] border border-[#808080] rounded-2xl p-1">View Profile</button>
                    ...
                    <select className="bg-white py-2 px-4 rounded-full">
                        <option className="bg-white text-[#40189D] text-sm font-semibold">+Take Action</option>
                        <option className="bg-white text-[#808080] text-sm border border-[#808080] font-bold py-2 px-4 rounded-full">Viewed</option>
                        <option className="bg-[#FE434E] text-[#FFFFFF] text-sm border border-[#FFFFFF] font-bold py-2 px-4 rounded-full">Rejected</option>
