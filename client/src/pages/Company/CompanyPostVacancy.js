                ...
                <div className="container rounded-2xl bg-lightPurple min-w-full min-h-full p-10 shadow-main-sd">
                    <form>
                        <div className="flex flex-row flex-wrap justify-between">
                            ...
                            <div className="flex flex-col min-w-[40%] min-h-full mb-3">
                                <label className="mb-1 font-semibold">No. of Positions:</label>
                        ...
                        <div className="flex flex-column flex-wrap justify-between">
                            ...
                            <textarea name='description' className="rounded-xl border border-purple w-[96%] focus:outline-none pl-4 mb-3 py-1" />
                        </div>
                        <div className="flex flex-row flex-wrap justify-between">
                            ...
                            <div className="flex flex-col min-w-[40%] min-h-full mb-4">
                                <label className="mb-1 font-semibold">{(jobType === 'internship') ? 'Duration:' : 'Salary:'}</label>
                                <input type='text' name='positionCount' className="rounded-xl border border-purple w-48 focus:outline-none pl-4 py-1" />
                            </div>
                        </div>
                        <div className="flex flex-row flex-wrap justify-between">
                            ...
                            <div className="flex flex-col min-w-[40%] min-h-full mb-4">
                                <label className="mb-1 font-semibold">Minimum Experience:</label>
                        ...
                        { (jobType === 'internship') && <div className="flex flex-col align-start mb-3">
                            <label className="mb-1 font-semibold text-black">Stipend:</label>
                            <div>
